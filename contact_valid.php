...
if($error=="")
{
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $mail->From = 'chetan.rajput@technomechindustries.com';
        $mail->FromName ='chetan.rajput@technomechindustries.com'; 
		$mail->addAddress('chetan.rajput@technomechindustries.com'); 
       
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Technomech Industries ';
        $mail->isHTML(true);
